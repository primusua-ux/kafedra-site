  ...
  return (
    <>
      <PageHero
        eyebrow="Розділ 01"
        title="Про кафедру"
        description="Кафедра військової підготовки Житомирського військового інституту імені С.П. Корольова — структурний підрозділ, що здійснює підготовку офіцерів запасу Збройних Сил України серед здобувачів вищої освіти."
          ...
          <div className="lg:col-span-2 space-y-8">
            <article>
              ...
              <p className="text-[--color-text-muted] leading-relaxed">
                ...
                освіти за програмою підготовки офіцерів запасу відповідно до
                Порядку, затвердженого Кабінетом Міністрів України. Навчання
                спрямоване на здобуття військово-облікових спеціальностей,
                необхідних для виконання обов’язків за офіцерським посадами
            ...
            <article>
              ...
              <p className="text-[--color-text-muted] leading-relaxed">
                ...
                службово-бойових завдань на офіцерських посадах після
                призначення на військову службу у разі мобілізації або
                добровільного вступу до лав Збройних Сил України.
              </p>
            </article>
            ...
            <article>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  { icon: Crosshair, title: "Практичність", desc: "Акцент на польових заняттях, стажуваннях та бойових вправах." },
